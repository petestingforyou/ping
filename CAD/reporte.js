...
const vigenciaCad =
    document.getElementById("vigenciaCad");

const vigenciaPac =
    document.getElementById("vigenciaPac");

const mesReporteTexto =
    document.getElementById("mesReporteTexto");

const vigenciaCadTexto =
    document.getElementById("vigenciaCadTexto");

const vigenciaPacTexto =
    document.getElementById("vigenciaPacTexto");

const cuerpoReporte =
    document.getElementById("cuerpoReporte");

const totalIncidencias =
    document.getElementById("totalIncidencias");

const nombreColaborador =
    document.getElementById("nombreColaborador");
...
if (!usuarioSesion) {
    ...
    mostrarMensaje(
        "No existe un usuario activo. Regresa al inicio de detecciones."
    );
...
// se mantiene como línea diferente.
//
// El usuario ya fue filtrado antes
// de llegar a esta función.
// ========================================

function agruparIncidencias(
    incidencias
) {
...
async function generarPDF() {
    ...
    try {
        ...
        const nombreArchivo =
            `Reporte_Incidencias_${usuarioSesion}_${mesReporte.value}.pdf`;
